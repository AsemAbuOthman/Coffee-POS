...
Public Class frmDeleteCustomers
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If Not txtFirstName.Text = "" And
            ...
            Try
                ...
                areYouSure = MessageBox.Show("Are your sure you want to Delete this Customer", "Delete Customer", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                ...
                If areYouSure = DialogResult.Yes Then
                    ...
                    Cmd.CommandText = "DELETE FROM CUSTOMERS WHERE Email = @Email"
                    Cmd.Connection = Conn
                    ...
                    obj_frmSignUp_Sccessfully1.lblSignUp.Text = "Customer Deleted Sccessfully"
