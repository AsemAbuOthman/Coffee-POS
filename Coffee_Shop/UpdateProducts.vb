...
Public Class frmUpdateProducts
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        If Not txtProductDescription.Text = "" And
            ...
            Try
                ...
                areYouSure = MessageBox.Show("Are your sure you want to Update this Product", "Update Prodcut", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                ...
                If areYouSure = DialogResult.Yes Then
                    ...
                    Cmd.CommandText = "UPDATE PRODUCTS SET  Description = @Description, Category = @Category, Price = @Price, Size = @Size, Available = @Available, Image_url = @Image_url, Image_data = @Image_data WHERE Name = @Name"
                    Cmd.Connection = Conn

                    Cmd.Parameters.AddWithValue("@Name", txtProductName.Text.Trim)
                    Cmd.Parameters.AddWithValue("@Description", txtProductDescription.Text)
                    Cmd.Parameters.AddWithValue("@Category", cmbCategory.Text)
                    Cmd.Parameters.AddWithValue("@Price", Format(Val(Replace(txtProductPrice.Text, "$", "")), "0.00"))
                    Cmd.Parameters.AddWithValue("@Size", cmbProduceSize.Text)
                    Cmd.Parameters.AddWithValue("@Available", bolAvailable)
                    ...
                    obj_frmSignUp_Sccessfully1.lblSignUp.Text = "  Product Updated Sccessfully"
